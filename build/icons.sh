...
sed 's/#8ADDD4/#000000/' build/icon/mark.svg | rsvg-convert -w 32 -h 32 -o internal/ui/icon_template.png
rsvg-convert -w 32 -h 32 build/icon/mark.svg -o internal/ui/icon.png
